...
@section('content')
  <div class="container mt-4 pt-5">
    <div class="row">
      ...
      <div class="col">
        <h1 class="text-center pt-5 pb-5 font-weight-bold">Reserach Platform</h2>
        <p class="text-center">
  ...
  <div class="container">
    <div class="container">
		<div data-aos="fade-up" data-aos-duration="1500">
          <h1 class="text-center pt-5 pb-5 font-weight-bold">Grid Computing</h1>
        </div>
        <p class="text-center">
		...
		<br><br><br>
		<div data-aos="fade-up" data-aos-duration="1500">
          <h1 class="text-center pt-5 pb-5 font-weight-bold">Network Test</h1>
        </div>
        <p class="text-center">
            Jaringan khusus tertutup nasional (National closed network)
			Jaringan khusus tertutup nasional (National closed network)

<html lang="en"><head>
	...
	<!-- Script with defer -->
	<script src="https://idren.id/js/awesomplete.js" defer=""></script>
		...
		<div class="row">
			<div class="col mt-5 pt-5">
				<div style="background-color:white;">
					<h1 class="font-weight-bold pl-5 pr-5 pt-5">Profile to IdREN</h1>
					<p class="pl-5 pr-5">Fill out your profile forms below</p>
					<form class="pl-5 pr-5 pb-5" method="POST" action="{{ route('profile.change') }}" enctype="multipart/form-data">
						@csrf
	          ...
	          <div class="form-group">
	            ...
	            <div class="custom-file">
	              <input class="custom-file-input" type="file" id="profilePic" name="profilePic" onchange="setfilename()">
	              <label class="custom-file-label text-muted" id="fileLabel" for="profilePic">Unggah foto</label>
	            </div>
	          </div>
	
						<div class="form-group">
							<input type="text" name="name"  class="form-control" id="name" value="{{$user->name}}" placeholder="Nama anda . . .">
						</div>
						...
						<div class="form-group">
							<input type="tel" name="phone_number" class="form-control" id="number" value="{{$user->phone_number}}" placeholder="Masukkan nomer Handphone anda. . .">
						</div>

						<div class="form-group">
							<label for="instansi_id">Pilih Instansi</label>
							<input name="instansi_id" id="instansi_id" class="form-control awesomplete" value="{{ $user->instansiName }}" list="mylist">
								<datalist id="mylist">
						...
						<button type="submit" class="btn btn-primary" style="border-radius: 30px">&nbsp; Save Profile &nbsp;
						</button>
					</form>

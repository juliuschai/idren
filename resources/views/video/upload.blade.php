...
@section('content')
    ...
    <div class="row">
      <div class="col-md-8 col-sm-12 mt-3">
        <div class="hmz-ajukan-penelitian">
          <h1 class="text-danger">Upload video</h1>
        </div>
        <form method="POST" action="{{ route('video.upload') }}" enctype="multipart/form-data" files="true">
          ...
          <div class="form-group">
            <div class="custom-file">
              <input class="custom-file-input" type="file" id="customVid" name="customVid" onchange="setfilename()">
              <label class="custom-file-label text-muted" id="fileLabel" for="customVid">Unggah file video</label>
            </div>
          </div>
          <div class="custom-file">
            <input class="custom-file-input" type="file" id="thumbnail" name="thumbnail" onchange="setfilename2()">
            <label class="custom-file-label text-muted" id="fileLabel2" for="thumbnail">Unggah thumbnail</label>
          </div>
          <div class="form-group row">
            <div class="col-auto ml-auto">
              <button type="submit" class="btn btn-danger">Upload Video</button>
            </div>
          </div>
        </form>
      </div>
  ...
  <script type="text/javascript">
    ...
    function setfilename2() {
      ...
      if(fileInput.files.length > 0) {
        document.getElementById('fileLabel2').innerHTML = fileInput.files[0].name;
      }
    }
  </script>
